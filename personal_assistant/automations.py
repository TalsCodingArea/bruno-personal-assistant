...
from personal_assistant.tools.legacy_helpers import (
    ask_openai,
    get_notion_pages,
...
def review_budget():
    ...
    """
    from personal_assistant.tools.monthly_budget.agent_tools import review_monthly_budget_status
    from personal_assistant.tools.notion_tools import get_income_between_dates
...
def backfill_spending_habits():
    ...
    """
    from personal_assistant.tools.notion_tools import get_expenses_between_dates
...
def log_expense(**properties):
    ...
    if url:
        message += f"\n{url}"
    try:
        from personal_assistant.tools.monthly_budget.budget_monitor import evaluate_logged_expense_budget, format_budget_alerts
