...
from personal_assistant.agent.capabilities.financial_advisor.context import FINANCIAL_ADVISOR_CONTEXT
...
from personal_assistant.tools.financial_advisor.formatting import compact_reasons, ils
...
def _load_monthly_budget_context(month: str) -> dict[str, Any]:
    try:
        ...
        from personal_assistant.tools.monthly_budget.notion_writer import list_budget_pages
...
def _default_write_executor(write_plan: dict[str, Any]) -> dict[str, Any]:
    ...
    from personal_assistant.tools.financial_advisor.memory import update_bank_account_balance
